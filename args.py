...
def argument_parser():
    ...
    parser.add_argument('--illumination-aug', action='store_true',
                        help='randomly alter the intensities of RGB channels')
    # ************************************************************
    ...
    parser.add_argument('--lambda-orth', type=float, default=1,
                        help='weight to balance hard triplet loss')
    # ************************************************************
    # Architecture
    # ************************************************************
    ...
    parser.add_argument('--include-color', action='store_true',
                        help='visualize ranked results, only available in evaluation mode')
    parser.add_argument('--include-ori', action='store_true',
                        help='visualize ranked results, only available in evaluation mode')
    ...
    parser.add_argument('--af', default=0.3, type=float,
                        help='visualize ranked results, only available in evaluation mode')
    parser.add_argument('--t1', default=0, type=float,
                        help='visualize ranked results, only available in evaluation mode')
    ...
    parser.add_argument('--warmup-iters', default=10, type=int,
                        help='visualize ranked results, only available in evaluation mode')
    parser.add_argument('--warmup-factor', default=0.1, type=float, help='no')

    # attn net
    parser.add_argument('--attn', action='store_true',
                        help='visualize ranked results, only available in evaluation mode')
    parser.add_argument('--num-prototypes', default=3, type=int,
                        help='visualize ranked results, only available in evaluation mode')
    parser.add_argument('--discard', default=1, type=int,
                        help='visualize ranked results, only available in evaluation mode')
    parser.add_argument('--num-dim', default=2048, type=int,
                        help='visualize ranked results, only available in evaluation mode')
    parser.add_argument('--stride3', default=2, type=int,
                        help='visualize ranked results, only available in evaluation mode')
    parser.add_argument('--has-global', action='store_true',
                        help='visualize ranked results, only available in evaluation mode')
...
def dataset_kwargs(parsed_args):
    ...
    return {
        ...
        'include_sim': parsed_args.include_sim,
        'illumination_aug': parsed_args.illumination_aug
    }
...
def lr_scheduler_kwargs(parsed_args, last_epoch=-1):
    """
